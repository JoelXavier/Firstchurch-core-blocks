  ...
  return (
    <footer className="fc-footer">
      ...
      <div className="fc-footer__content">
        ...
        <div className="fc-footer__nav-grid">
          {columns.map((col, idx) => (
            <div key={idx} className="fc-footer__nav-col">
        ...
        <div className="fc-footer__bottom-inner">
          ...
          <div className="fc-footer__socials">
            {socialLinks.map((social, idx) => (
              <a key={idx} href={social.url} aria-label={social.label} className="fc-footer__social-icon">
