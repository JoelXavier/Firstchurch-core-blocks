...
$wrapper_attributes = get_block_wrapper_attributes(['class' => 'antigravity-hero-wrapper']);
...
<div <?php echo $wrapper_attributes; ?> style="position: relative;">
    ...
    <div class="antigravity-hero-background-root antigravity-hero__media" data-props="<?php echo $props_json; ?>"
        ...
        <?php if (!empty($media[0]['url'])): ?>
            ...
            <div class="antigravity-hero__overlay"
    ...
    <div class="antigravity-hero antigravity-hero--layout-<?php echo esc_attr($layout); ?>"
        style="background:transparent; pointer-events:none; position:relative; z-index:1;">
        <div class="antigravity-hero__content" style="pointer-events:auto;">
            <?php echo $content; ?>
        </div>
    </div>
